...
public class CulturalCharacteristicsTableModel extends AbstractTableModel{
	
	private static final int COL_DESCRIPTION = 0;
	List<CulturalPersonalCharacteristic> line;
	private String[] column = new String[]{"Cultural Characteristic"};
	
	public CulturalCharacteristicsTableModel(List<CulturalPersonalCharacteristic> cpc) {
